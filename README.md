...
- Full-body Magic Mirror builder with tops, bottoms, layers, shoes, and accessories
- Category-aware contain framing so full items and footwear are never cropped
- Search, favorites, shuffle, saved looks, wishlist, and local persistence
- Add Item flow with photo preview
- Curated Discover samples with Recreate It closet matching
- Manual weather-aware suggestions and Pack With Me travel capsules
- Mobile/tablet/desktop responsive layouts and V2.1 storage compatibility
